...
<div class="space-y-6">
    ...
    <div class="mx-auto bg-white rounded-2xl shadow-xl relative overflow-hidden" style="{{ $previewPaperStyle }}">
        @if ($mitraTemplateAsset)
            <div style="position:absolute;inset:0;background-image:url('{{ $mitraTemplateAsset }}');background-repeat:no-repeat;background-position:center -10mm;background-size:100% 100%;z-index:0;"></div>
        @else
            @if ($bgAsset)
