...
@php
    ...
    $invoiceFooter = file_exists($invoiceFooterPath)
        ...
        : null;
    $previewStyle = 'width: 100%; max-width: 794px; min-height: 1123px; padding: 50mm 22mm 6mm 6mm; background-size: 100% auto; background-repeat: no-repeat; background-position: top center;';
    if ($documentTemplate) {
